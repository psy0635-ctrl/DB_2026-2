...
-- 1. 고객 테이블에서 고객아이디, 고객이름, 직업을 검색하시오.
SELECT 고객아이디, 고객이름, 직업
    FROM 고객;

-- 2. 고객 테이블에서 등급에 'i'가 포함된 행의 고객이름, 등급을 검색하시오.
SELECT 고객이름, 등급
    FROM 고객
    WHERE 등급 LIKE '%i%';

-- 3. 고객 테이블에서 나이가 20세 이상아고 25세 미만인 고객을 검색하시오.
SELECT *
    FROM 고객
    WHERE 나이 >= 20 AND 나이 < 25;

-- 4. 고객 테이블에서 등급이 'gold' 이고 적립금이 3000원이상인 고객을 검색하시오.
SELECT *
    FROM 고객
...
-- 고객 테이블에서 성이 김씨 이면서 고객아이디가 6글자인 고객을 검색하시오.
SELECT *
FROM 고객
WHERE 고객이름 LIKE '김%' AND 고객아이디 LIKE '______';

-- 고객 테이블에서 직업이 학생 또는 회사원인 고객을 검색하시오.
SELECT *
FROM 고객
...
-- 고객 테이블에서 나이가 입력되지 않은(NULL) 고객을 검색하시오.
SELECT *
FROM 고객
WHERE 나이 IS NULL;

-- 고객 테이블에서 나이가 입력된 고객을 검색하시오.
SELECT *
FROM 고객
